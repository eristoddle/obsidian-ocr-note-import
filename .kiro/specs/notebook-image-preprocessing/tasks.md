...
- [ ] 1. Define preprocessing configuration data structures
  - [ ] 1.1 Create preprocessing configuration enums and interfaces
  ...
  - [ ] 1.2 Define preset configurations
  ...
  - [ ] 1.3 Create preprocessing result interfaces
...
- [ ] 2. Implement configuration manager
  - [ ] 2.1 Create PreprocessingConfigManager class
  ...
  - [ ] 2.2 Implement configuration retrieval methods
  ...
  - [ ] 2.3 Implement configuration management methods
  ...
  - [ ] 2.5 Write property test for page count validation
    - **Property 2: Page count validation**
    - **Validates: Requirements 2.4**

  - [ ] 2.6 Write property test for configuration persistence
    - **Property 3: Configuration persistence round-trip**
    - **Validates: Requirements 2.5, 3.5**

  - [ ] 2.7 Write property test for default configuration
    - **Property 4: Default configuration retrieval**
    - **Validates: Requirements 6.3**

  - [ ] 2.8 Write property test for configuration deletion
    - **Property 5: Custom configuration deletion**
    - **Validates: Requirements 6.4**

  - [ ] 2.9 Write property test for configuration duplication
    - **Property 6: Configuration duplication creates independent copy**
    - **Validates: Requirements 6.5**

  - [ ] 2.10 Implement configuration validation
...
- [ ] 3. Implement image splitter
  ...
  - [ ] 3.5 Implement dimension validation
  ...
  - [ ] 3.6 Write property test for split page count
    - **Property 10: Split page OCR count**
    - **Validates: Requirements 5.3**

- [ ] 4. Implement image rotator
  - [ ] 4.1 Create ImageRotator class
    - Implement rotate(imageData, angle) method
    - Return original image if angle is 0°
    - _Requirements: 3.1, 3.2, 5.2_

  - [ ] 4.2 Implement rotation transformation
...
- [ ] 5. Implement preprocessing manager
  ...
  - [ ] 5.3 Implement rotation before split
  ...
  - [ ] 5.5 Implement rotation after split
...
- [ ] 6. Implement preview generator
  ...
  - [ ] 6.2 Implement thumbnail generation
  ...
  - [ ] 6.3 Write property test for preview OCR isolation
    - **Property 7: Preview does not trigger OCR**
    - **Validates: Requirements 4.5**

- [ ] 7. Update plugin settings
  - [ ] 7.1 Add preprocessing settings to PluginSettings interface
...
- [ ] 8. Implement preprocessing error handling
  - [ ] 8.1 Create preprocessing error types
    - Define PreprocessingErrorType enum
    - Create PreprocessingError class extending Error
    - Add type and configId fields
    - _Requirements: 10.1, 10.2, 10.3_

  - [ ] 8.2 Create PreprocessingErrorHandler class
  ...
  - [ ] 8.3 Write property test for dimension validation errors
    - **Property 21: Invalid dimension error handling**
    - **Validates: Requirements 10.1**

  - [ ] 8.4 Write property test for rotation failure fallback
    - **Property 22: Rotation failure fallback**
    - **Validates: Requirements 10.2**

  - [ ] 8.5 Write property test for small page skipping
    - **Property 23: Small page skipping**
    - **Validates: Requirements 10.3**

- [ ] 9. Integrate preprocessing into OCR pipeline
  - [ ] 9.1 Initialize preprocessing components in plugin
  ...
  - [ ] 9.2 Implement processImageWithPreprocessing method
  ...
  - [ ] 9.5 Write property test for original image preservation
    - **Property 12: Original image preservation**
    - **Validates: Requirements 5.5**

- [ ] 10. Implement note creation for split pages
  - [ ] 10.1 Implement createNotesFromPages method
  ...
  - [ ] 10.2 Implement separate note creation
  ...
  - [ ] 10.3 Implement combined note creation
  ...
  - [ ] 10.4 Implement note content generation helpers
  ...
  - [ ] 10.5 Write property test for separate note creation
    - **Property 14: Separate note creation count**
    - **Validates: Requirements 8.1**

  - [ ] 10.6 Write property test for combined note separators
    - **Property 15: Combined note separator count**
    - **Validates: Requirements 8.2**

  - [ ] 10.7 Write property test for page numbers in titles
    - **Property 16: Page numbers in separate note titles**
    - **Validates: Requirements 8.3**

  - [ ] 10.8 Write property test for separator markers
    - **Property 17: Separator markers in combined notes**
    - **Validates: Requirements 8.4**

  - [ ] 10.9 Write property test for rule application
    - **Property 18: Rule application to split pages**
    - **Validates: Requirements 8.5**

  - [ ] 10.10 Write property test for metadata inclusion
    - **Property 19: Metadata inclusion based on setting**
    - **Property 20: Metadata contains configuration details**
    - **Validates: Requirements 9.2, 9.3**

- [ ] 11. Implement preprocessing settings UI
  - [ ] 11.1 Create PreprocessingSettingsUI class
  ...
  - [ ] 11.2 Implement default configuration selection
  ...
  - [ ] 11.3 Display preset configurations
  ...
  - [ ] 11.4 Display custom configurations
...
- [ ] 12. Implement configuration editor modal
  - [ ] 12.1 Create ConfigEditorModal class
  ...
  - [ ] 12.2 Implement configuration name and description inputs
    - Add text input for configuration name
    - Add text input for configuration description
    - _Requirements: 6.1_

  - [ ] 12.3 Implement split settings UI
  ...
  - [ ] 12.4 Implement rotation settings UI
  ...
  - [ ] 12.5 Implement save and cancel buttons
...
- [ ] 13. Implement configuration selection modal
  - [ ] 13.1 Create ConfigSelectionModal class
    - Extend Obsidian Modal class
    - Accept plugin and callback in constructor
    - _Requirements: 7.1, 7.2_

  - [ ] 13.2 Display configuration options
  ...
  - [ ] 13.3 Handle configuration selection
    - Add select button for each configuration
    - Call callback with selected config ID
    - Close modal after selection
    - _Requirements: 7.5_

- [ ] 14. Add preprocessing to image processing commands
  - [ ] 14.1 Update process image command
  ...
  - [ ] 14.2 Add completion notification
...
- [ ] 16. Update documentation
  ...
  - [ ] 16.3 Create preprocessing user guide
